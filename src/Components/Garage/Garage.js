...
export default class Garage extends Component {
    ...
    componentDidMount(){
        ...
        svg
			.append('image')
			.attr(
				'href', 'https://image.flaticon.com/icons/svg/1538/1538118.svg'
			)
			.attr('id', 'hammer')
			.attr('x', 50)
            .attr('y', 330);
        ...
        svg
			.append('image')
			.attr(
				'href', 'https://image.flaticon.com/icons/svg/1538/1538124.svg'
			)
			.attr('id', 'saw')
			.attr('x', 150)
            .attr('y', 315);
        ...
        svg
			.append('image')
			.attr(
				'href', 'https://image.flaticon.com/icons/svg/123/123935.svg'
			)
			.attr('id', 'chainsaw')
			.attr('x', 250)
            .attr('y', 320);
        ...
        svg
			.append('image')
			.attr(
				'href', 'https://image.flaticon.com/icons/svg/289/289690.svg'
			)
			.attr('id', 'screws')
			.attr('x', 350)
            .attr('y', 320);
        ...
        svg
			.append('image')
			.attr(
				'href', 'https://image.flaticon.com/icons/svg/1589/1589247.svg'
			)
			.attr('id', 'tapemeasure')
			.attr('x', 420)
            .attr('y', 335);
    ...
    handleSubmit = (event) => {
        alert('The size of your container is: ' + this.state.value);
